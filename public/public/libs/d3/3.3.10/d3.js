d3 = function () {
  ...
  d3_selectionPrototype.classed = function (name, value) {
    ...
    //找出点击的哪一个
    if (value) {
      // console.log(name, value, this.each(d3_selection_classed(name, value)))
    }
  ...
  function d3_xhr (url, mimeType, response, callback) {
    ...
    function respond () {
      ...
      if (!status && request.responseText || status >= 200 && status < 300 || status === 304) {
        try {
          ...
          console.log('返回结果：', result, response)
    ...
    xhr.send = function (method, data, callback) {
      ...
      console.log(method, 1, data, 1, callback)
  ...
  d3.json = function (url, callback) {
    console.log(d3_xhr(url, "application/json", d3_json, callback))

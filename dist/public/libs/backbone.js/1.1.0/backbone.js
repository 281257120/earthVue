...
(function () {
  ...
  var Events = Backbone.Events = {
    ...
    //触发一个或多个事件，触发所有绑定回调。回调是
    //除了事件名称之外，传递的参数与'trigger'的参数相同
    //（除非您正在收听“全部”，否则将导致您的回调失败。）
    //接收事件的真实名称作为第一个参数）。
  ...
  //反转“on”和“once”的控制版本。告诉*此*对象侦听另一个对象中的事件。。。跟踪它在听什么。
